...
private:
    ...
    void drawFrame()
    {
        vkWaitForFences(device, 1, &inFlightFence, VK_TRUE, UINT64_MAX); // wait until previous frame has finished
        vkResetFences(device, 1, &inFlightFence); //reset fence to unsignaled
