...
private:
    ...
    VkFormat findDepthFormat()  // select a format with a depth component that supports usage as depth attachment:
    {
    ...
    Window m_Window;
    Instance m_Instance;
    //PLEASE STILL REFACTOR "DEBUGMESSENGER IN INSTACE
