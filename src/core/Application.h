...
private:
    ...
    //     m_pSwapChain = new cat::SwapChain(*m_Device, m_Window->GetWindow());
    //     createDescriptorSetLayout();
    //     m_pGraphicsPipeline = new cat::Pipeline(
    //         m_Device->GetDevice(),
    //         "shaders/simple_shader.vert.spv",
    //         "shaders/simple_shader.frag.spv",
    //         m_pSwapChain->GetRenderPass(), m_pSwapChain->GetSwapChainExtent(), descriptorSetLayout
    //     );
    //     createTextureImage();
    //     createTextureImageView();
    //     createTextureSampler();
    //     m_pModel = new cat::Model(*m_Device, vertices, indices);
